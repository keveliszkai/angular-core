...
import { ReactiveCreateComponent } from './reactive-create.component';
...
class TestCreateComponent extends ReactiveCreateComponent<TestObject> implements OnInit {
  ngOnInit() {
    super.ngOnInit();
  }
...
describe('Component: ReactiveCreateComponent', () => {
